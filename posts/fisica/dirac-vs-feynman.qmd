...
## 🧩 Quiz — Dirac vs Feynman

:::::{.question}
**Q1.** No ensaio, Dirac é apresentado como um físico que valorizava sobretudo:

::::{.choices}
:::{.choice .correct-choice}
Beleza matemática, simetria e necessidade formal.
:::

:::{.choice}
Improviso experimental sem formalismo.
:::

:::{.choice}
A recusa da abstração matemática.
:::
...
:::::{.question}
**Q2.** Feynman representa, em contraste com Dirac:

::::{.choices}
:::{.choice .correct-choice}
A Física como cálculo, intuição, visualização e contato com fenômenos concretos.
:::

:::{.choice}
A Física como pura dedução axiomática sem experimentos.
:::

:::{.choice}
A ideia de que diagramas não têm utilidade científica.
:::
...
:::::{.question}
**Q3.** A relação entre formalismo e intuição é descrita como:

::::{.choices}
:::{.choice}
Um conflito em que a Física precisa escolher apenas um lado.
:::

:::{.choice .correct-choice}
Uma tensão criativa que impulsiona a Física.
:::

:::{.choice}
Um problema meramente biográfico sem importância epistemológica.
:::
...
:::::{.question}
**Q4.** Na analogia histórica do texto, Feynman e Dirac se aproximam, respectivamente, de:
...
🎯 **Anterior:** 👉 [Feynman e Gell-Mann](feynman-gellmann-babilonia-grecia.qmd)

🎯 **Próximo:** 👉 [Einstein: físico ou filósofo natural?](einstein-fisico-ou-filosofo-natural.qmd)
