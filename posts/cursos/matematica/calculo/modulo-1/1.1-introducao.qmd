...
***
## 🧩 Quiz — O que é Cálculo?

:::::{.question}
**Q1.** Nesta introdução, o cálculo aparece principalmente como o estudo de:

::::{.choices}
:::{.choice}
Somente geometria plana sem funções.
:::

:::{.choice}
Apenas operações aritméticas com números naturais.
:::

:::{.choice .correct-choice}
Mudança, acúmulo e limites.
:::
...
:::::{.question}
**Q2.** O problema da tangente está ligado à ideia de:

::::{.choices}
:::{.choice .correct-choice}
Determinar a inclinação instantânea de uma curva em um ponto.
:::

:::{.choice}
Contar quantos pontos existem em uma reta.
:::

:::{.choice}
Calcular apenas áreas de polígonos regulares.
:::
...
:::::{.question}
**Q3.** O método de exaustão de Arquimedes antecipa qual ideia do cálculo?

::::{.choices}
:::{.choice .correct-choice}
Aproximar uma grandeza por objetos mais simples e estudar o valor limite dessa aproximação.
:::

:::{.choice}
Evitar aproximações e trabalhar apenas com números inteiros.
:::

:::{.choice}
Substituir toda geometria por tabelas sem interpretação visual.
:::
