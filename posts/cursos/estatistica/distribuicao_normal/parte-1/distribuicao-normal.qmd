...
::: {.callout-note collapse=true title="👨‍💻 🐍 Código Python — gerar a figura"}
```{python}
#| label: regra-empirica-py
#| echo: true
#| fig-cap: "Distribuição de QI — Regra Empírica com faixas separadas."
#| fig-align: center
#| fig-width: 6
#| fig-height: 3.6
#| out-width: 70%
...
# Criar figura (sem figsize para usar fig-width/fig-height do Quarto)
fig, ax = plt.subplots()
...
::: {.callout-note collapse=true title="📊 R — gerar figura com ggplot2"}
```{r}
#| label: regra-empirica-r
#| echo: true
#| fig-cap: "Distribuição de QI — Regra Empírica com ggplot2."
#| fig-align: center
#| fig-width: 6
#| fig-height: 3.6
#| out-width: 70%
...
<!-- Breadcrumbs -->
· [← Sumário do Curso](../index.qmd) · [← Cursos de Estatística](../../index.qmd) · [← Seção de Estatística](../../../../estatistica/index.qmd) · 🔝 [Topo](#top)
