...
1. **Pré-treinamento** → ensina a linguagem em geral.  
2. **Fine-tuning** → adapta para seguir instruções.  
3. **RLHF** → refina com preferências humanas.  
...
No próximo post, vamos explorar os **desafios e limitações dos LLMs**: vieses, alucinações e custos de treinamento. ⚠️
