...
:::::{.question}
**Q1.** Segundo o texto, o futuro da IA dependerá principalmente de:

::::{.choices}
:::{.choice}
Uma única tecnologia milagrosa que resolverá todos os problemas.
:::

:::{.choice .correct-choice}
Modelos melhores, avaliação rigorosa, governança, infraestrutura sustentável e uso responsável.
:::

:::{.choice}
Abandonar completamente avaliação, segurança e supervisão humana.
:::
::::
:::::

:::::{.question}
**Q2.** Uma lição importante para o futuro da IA é que:

::::{.choices}
:::{.choice}
Capacidade técnica é sempre igual a confiabilidade.
:::

:::{.choice .correct-choice}
Modelos mais capazes também precisam ser avaliáveis, verificáveis e corrigíveis.
:::

:::{.choice}
Sistemas de IA não precisam ser auditados quando parecem funcionar bem.
:::
::::
:::::

## ⚠️ Modelos mais capazes, mas não infalíveis
...
## 🧩 Quiz — Avaliação e confiabilidade

:::::{.question}
**Q3.** Avaliar IA é difícil porque:

::::{.choices}
:::{.choice}
Todo benchmark mede perfeitamente o uso real.
:::

:::{.choice .correct-choice}
Um sistema pode ir bem em testes padronizados e ainda falhar em situações reais.
:::

:::{.choice}
Modelos de IA nunca mudam de comportamento entre contextos diferentes.
:::
::::
:::::
...
## 🧩 Quiz — Alinhamento e segurança

:::::{.question}
**Q4.** O problema do **alinhamento** em IA envolve:

::::{.choices}
:::{.choice .correct-choice}
Fazer sistemas seguirem objetivos, valores e restrições humanas.
:::

:::{.choice}
Apenas aumentar o número de parâmetros de um modelo.
:::

:::{.choice}
Eliminar completamente a necessidade de regras e governança.
:::
::::
:::::
...
:::::{.question}
**Q5.** Um agente de IA com acesso a ferramentas exige mais cuidado porque:

::::{.choices}
:::{.choice .correct-choice}
Pode executar ações com consequências práticas, não apenas gerar texto.
:::

:::{.choice}
Não precisa de limites de permissão nem supervisão.
:::

:::{.choice}
Nunca comete erros quando chama APIs ou executa código.
:::
::::
:::::
...
:::::{.question}
**Q6.** Uma preocupação importante sobre IA em larga escala é:

::::{.choices}
:::{.choice .correct-choice}
O consumo de energia, água, chips, infraestrutura e capacidade computacional.
:::

:::{.choice}
A impossibilidade de usar modelos menores em qualquer tarefa.
:::

:::{.choice}
A ausência completa de custos em data centers.
:::
::::
:::::

## ⚛️ IA quântica: promessa com cautela
...
## ⚖️ Governança, regulação e responsabilidade
...
## 🧩 Quiz — Governança e responsabilidade

:::::{.question}
**Q7.** Governança em IA envolve:

::::{.choices}
:::{.choice .correct-choice}
Proteção de dados, transparência, auditorias, responsabilidade e regras para uso em áreas sensíveis.
:::

:::{.choice}
Permitir qualquer uso sem prestação de contas.
:::

:::{.choice}
Excluir completamente debates sobre sociedade, trabalho e educação.
:::
::::
:::::

:::::{.question}
**Q8.** Quando o texto diz que IA é “infraestrutura social”, isso significa que:

::::{.choices}
:::{.choice}
IA é apenas um programa isolado sem impacto coletivo.
:::

:::{.choice .correct-choice}
Seu uso afeta instituições, trabalho, educação, cultura, direitos e responsabilidades sociais.
:::

:::{.choice}
Modelos de IA devem substituir todas as decisões humanas.
:::
::::
:::::

## 🗓️ Linha do tempo possível
