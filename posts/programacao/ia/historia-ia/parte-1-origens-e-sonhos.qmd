...
## 🕰️ Contexto histórico: antes de 1956
...
## 🧩 Quiz — Raízes da Inteligência Artificial

:::::{.question}
**Q1.** Segundo o texto, a pré-história da IA nasce da convergência entre:

::::{.choices}
:::{.choice}
Apenas computadores pessoais, internet e smartphones.
:::

:::{.choice .correct-choice}
Cálculo simbólico, probabilidade/estatística e sistemas de controle e comunicação.
:::

:::{.choice}
Somente redes sociais e modelos de linguagem modernos.
:::
::::
:::::

## ⚙️ Dos autômatos ao sonho da máquina racional
...
## 🧩 Quiz — Cibernética e informação

:::::{.question}
**Q2.** A teoria da informação de Shannon foi importante porque:

::::{.choices}
:::{.choice}
Eliminou a necessidade de computadores digitais.
:::

:::{.choice .correct-choice}
Permitiu tratar informação, ruído, canal e codificação de forma matemática.
:::

:::{.choice}
Criou diretamente os grandes modelos de linguagem atuais.
:::
::::
:::::

:::::{.question}
**Q3.** Na cibernética, a ideia de **feedback** está relacionada a:

::::{.choices}
:::{.choice .correct-choice}
Um sistema ajustar seu comportamento com base nos efeitos de suas próprias ações.
:::

:::{.choice}
Um computador armazenar todos os textos possíveis.
:::

:::{.choice}
Uma máquina funcionar sem qualquer entrada externa.
:::
::::
:::::
...
## 🧩 Quiz — Neurônio lógico

:::::{.question}
**Q4.** O modelo de McCulloch e Pitts foi importante porque:

::::{.choices}
:::{.choice}
Mostrou que neurônios biológicos poderiam ser ignorados pela ciência.
:::

:::{.choice}
Provou que computadores já eram conscientes em 1943.
:::

:::{.choice .correct-choice}
Sugeriu que certos aspectos do cérebro poderiam ser modelados como processamento formal de informação.
:::
::::
:::::
