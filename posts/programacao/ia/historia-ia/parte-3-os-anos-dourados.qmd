...
## 🧩 Quiz — GOFAI e IA simbólica

:::::{.question}
**Q1.** A abordagem conhecida como **GOFAI** apostava principalmente em:

::::{.choices}
:::{.choice}
Redes neurais profundas treinadas com bilhões de imagens.
:::

:::{.choice .correct-choice}
Símbolos, regras, lógica e busca heurística para representar a inteligência.
:::

:::{.choice}
Modelos multimodais capazes de gerar texto, imagem e áudio.
:::
::::
:::::

:::::{.question}
**Q2.** Nos anos dourados da IA, muitos pesquisadores acreditavam que a inteligência poderia ser:

::::{.choices}
:::{.choice}
Completamente explicada apenas por força bruta computacional.
:::

:::{.choice}
Ignorada como tema científico.
:::

:::{.choice .correct-choice}
Decomposta em operações simbólicas, regras e estratégias de busca.
:::
::::
:::::
...
## 🧩 Quiz — LISP e manipulação simbólica

:::::{.question}
**Q3.** A linguagem **LISP** tornou-se importante para a IA simbólica porque:

::::{.choices}
:::{.choice}
Foi criada para editar imagens e vídeos em tempo real.
:::

:::{.choice .correct-choice}
Facilitava a manipulação de listas, expressões simbólicas e estruturas recursivas.
:::

:::{.choice}
Eliminava completamente a necessidade de algoritmos.
:::
::::
:::::

## ♟️ Planejamento, jogos e prova automática
...
## 🗣️ SHRDLU: linguagem natural em um mundo de blocos
...
## 🧩 Quiz — Micromundos e SHRDLU

:::::{.question}
**Q4.** Um **micromundo** em IA é:

::::{.choices}
:::{.choice .correct-choice}
Um ambiente simplificado, com regras, objetos e vocabulário limitados.
:::

:::{.choice}
Um computador pequeno usado apenas em laboratórios antigos.
:::

:::{.choice}
Uma rede neural treinada com milhões de imagens.
:::
::::
:::::

:::::{.question}
**Q5.** O sucesso do SHRDLU dependia principalmente:

::::{.choices}
:::{.choice}
Da ausência completa de linguagem natural.
:::

:::{.choice .correct-choice}
Da simplicidade e limitação do mundo de blocos em que ele operava.
:::

:::{.choice}
Da existência de modelos de linguagem modernos.
:::
::::
:::::
...
## 🧩 Quiz — Limites da IA simbólica

:::::{.question}
**Q6.** A **explosão combinatória** é um problema porque:

::::{.choices}
:::{.choice}
Reduz todos os problemas a uma única resposta simples.
:::

:::{.choice}
Impede que computadores manipulem símbolos.
:::

:::{.choice .correct-choice}
O número de possibilidades cresce rapidamente, tornando inviável testar todos os caminhos.
:::
::::
:::::

:::::{.question}
**Q7.** Uma lição dos anos dourados da IA é que:

::::{.choices}
:::{.choice}
Resolver problemas em micromundos garante sucesso imediato no mundo real.
:::

:::{.choice .correct-choice}
Sistemas simbólicos podem funcionar bem em ambientes controlados, mas enfrentar dificuldades no mundo aberto.
:::

:::{.choice}
A linguagem natural não envolve ambiguidade nem contexto.
:::
::::
:::::
