...
## 🧩 Quiz — Renascimento da IA

:::::{.question}
**Q1.** O renascimento da IA foi impulsionado principalmente por:

::::{.choices}
:::{.choice}
O abandono completo da estatística e dos dados.
:::

:::{.choice .correct-choice}
Aprendizado de máquina, maior disponibilidade de dados e aumento da capacidade computacional.
:::

:::{.choice}
A substituição imediata de todos os computadores por sistemas quânticos.
:::
::::
:::::

:::::{.question}
**Q2.** Uma mudança importante desse período foi a passagem de sistemas baseados apenas em regras explícitas para sistemas capazes de:
...
:::{.choice}
Evitar qualquer forma de avaliação.
:::

:::{.choice}
Funcionar sem exemplos, sem computação e sem treinamento.
:::
::::
:::::
...
:::::{.question}
**Q3.** As **SVMs** ganharam destaque porque:

::::{.choices}
:::{.choice}
Eram modelos voltados exclusivamente à geração de imagens.
:::

:::{.choice .correct-choice}
Usavam margens e kernels para resolver problemas de classificação e reconhecimento de padrões.
:::

:::{.choice}
Eliminavam completamente a necessidade de dados de treinamento.
:::
::::
:::::
...
## ⚖️ Viés, variância e generalização
...
:::::{.question}
**Q4.** Em aprendizado de máquina, **generalização** significa:

::::{.choices}
:::{.choice}
Decorar exatamente todos os exemplos de treinamento.
:::

:::{.choice .correct-choice}
Funcionar bem em dados novos que o modelo ainda não viu.
:::

:::{.choice}
Eliminar a necessidade de validação e testes.
:::
::::
:::::

:::::{.question}
**Q5.** Um modelo com variância muito alta tende a:

::::{.choices}
:::{.choice}
Ser simples demais e ignorar todos os padrões dos dados.
:::

:::{.choice .correct-choice}
Ajustar-se demais aos dados de treinamento e falhar em novos exemplos.
:::

:::{.choice}
Nunca precisar de regularização.
:::
::::
:::::

## 🛡️ Regularização e avaliação
...
## 🧩 Quiz — Deep learning e ImageNet

:::::{.question}
**Q6.** A virada associada à ImageNet e à AlexNet mostrou que:

::::{.choices}
:::{.choice .correct-choice}
Redes profundas podiam obter resultados muito fortes em visão computacional quando combinadas com dados, GPUs e boas arquiteturas.
:::

:::{.choice}
A IA simbólica havia resolvido definitivamente todos os problemas de percepção.
:::

:::{.choice}
Benchmarks não tinham nenhuma importância para medir avanços.
:::
::::
:::::
