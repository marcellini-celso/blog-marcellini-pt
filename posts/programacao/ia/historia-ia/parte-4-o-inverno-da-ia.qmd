...
## 🧩 Quiz — O inverno da IA

:::::{.question}
**Q1.** A expressão **inverno da IA** se refere principalmente a:

::::{.choices}
:::{.choice}
Um período em que computadores deixaram de funcionar em países frios.
:::

:::{.choice .correct-choice}
Períodos de queda de entusiasmo, financiamento e confiança na Inteligência Artificial.
:::

:::{.choice}
Uma técnica usada para resfriar servidores de modelos generativos.
:::
::::
:::::

:::::{.question}
**Q2.** Segundo o texto, um dos motivos centrais do inverno da IA foi:

::::{.choices}
:::{.choice}
O excesso de sucesso imediato em todos os problemas reais.
:::

:::{.choice .correct-choice}
O desalinhamento entre promessas ambiciosas e resultados práticos limitados.
:::

:::{.choice}
A ausência completa de pesquisas em lógica e computação.
:::
::::
:::::
...
## 🧩 Quiz — Relatório Lighthill

:::::{.question}
**Q3.** O Relatório Lighthill teve impacto porque:

::::{.choices}
:::{.choice}
Defendeu que a IA já havia resolvido todos os problemas de linguagem natural.
:::

:::{.choice .correct-choice}
Questionou resultados, promessas e financiamento de parte da pesquisa em IA.
:::

:::{.choice}
Criou a arquitetura Transformer.
:::
::::
:::::
...
## 🧩 Quiz — Micromundos e mundo aberto

:::::{.question}
**Q4.** A diferença entre micromundos e mundo aberto mostrou que:

::::{.choices}
:::{.choice}
Sistemas bons em ambientes controlados sempre funcionam melhor no mundo real.
:::

:::{.choice .correct-choice}
Ambientes reais têm ambiguidade, incerteza, exceções e complexidade muito maiores.
:::

:::{.choice}
A IA simbólica nunca usou regras nem representações.
:::
::::
:::::
...
## 🧩 Quiz — Sistemas especialistas

:::::{.question}
**Q5.** Uma limitação importante dos sistemas especialistas era que eles:

::::{.choices}
:::{.choice}
Aprendiam automaticamente com grandes volumes de dados sem intervenção humana.
:::

:::{.choice .correct-choice}
Dependiam de regras escritas manualmente e eram frágeis fora de seu domínio.
:::

:::{.choice}
Eram modelos multimodais treinados com imagens, áudio e vídeo.
:::
::::
:::::

:::::{.question}
**Q6.** O segundo inverno da IA esteve ligado, em parte, à frustração com:

::::{.choices}
:::{.choice .correct-choice}
O mercado de sistemas especialistas.
:::

:::{.choice}
A inexistência de computadores no período.
:::

:::{.choice}
O sucesso imediato da computação quântica comercial.
:::
::::
:::::
